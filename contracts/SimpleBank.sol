...
contract SimpleBank {
    ...
    //// @notice Avoid access to not enrolled users
    modifier onlyEnrolledUser() {
    ...
    function deposit() public payable onlyEnrolledUser returns (uint) {
    ...
    function withdraw(uint withdrawAmount) public noReentrant returns (uint) {
      ...
      require(balances[msg.sender] >= withdrawAmount, "You do not have enough balance to withdraw this amount");
